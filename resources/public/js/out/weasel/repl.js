...
repl_print.cljs$lang$applyTo = (function (arglist__11057){
...
console_print.cljs$lang$applyTo = (function (arglist__11058){
...
return G__11059__delegate(args);
});
...
var connect__delegate = function (repl_server_url,p__11061){
...
var print = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var on_close = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_error = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_open = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var verbose = cljs.core.get.call(null,map__11064__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
});})(repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
var map__11065 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__11065__$1;
var op = cljs.core.get.call(null,map__11065__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__11064,map__11064__$1,print,on_close,on_error,on_open,verbose){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
if (arguments.length > 1) {
  p__11061 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return connect__delegate.call(this,repl_server_url,p__11061);};
connect.cljs$lang$maxFixedArity = 1;
connect.cljs$lang$applyTo = (function (arglist__11066){
var repl_server_url = cljs.core.first(arglist__11066);
var p__11061 = cljs.core.rest(arglist__11066);
return connect__delegate(repl_server_url,p__11061);
});
