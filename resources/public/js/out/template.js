...
enfocus.core.load_remote_dom.call(null,"/landing-body.html","remote/landing-body.html","en5835_");
...
var vec__5858 = (function (){
return enfocus.core.get_cached_dom.call(null,"remote/landing-body.html");
}).call(null);
var id_sym5855 = cljs.core.nth.call(null,vec__5858,(0),null);
var pnod5856 = cljs.core.nth.call(null,vec__5858,(1),null);
var pnod5856__$1 = enfocus.core.create_hidden_dom.call(null,pnod5856);
enfocus.core.i_at.call(null,id_sym5855,pnod5856__$1);

enfocus.core.reset_ids.call(null,id_sym5855,pnod5856__$1);

return enfocus.core.remove_node_return_child.call(null,pnod5856__$1);
});

enfocus.core.load_remote_dom.call(null,"/account-row.html","remote/account-row.html","en5840_");
...
var vec__5862 = (function (){
return enfocus.core.get_cached_dom.call(null,"remote/account-row.html");
}).call(null);
var id_sym5859 = cljs.core.nth.call(null,vec__5862,(0),null);
var pnod5860 = cljs.core.nth.call(null,vec__5862,(1),null);
var pnod5860__$1 = enfocus.core.create_hidden_dom.call(null,pnod5860);
enfocus.core.i_at.call(null,id_sym5859,pnod5860__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [".account-row"], null),enfocus.core.append.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(account)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [".account-row"], null),enfocus.events.listen.call(null,new cljs.core.Keyword(null,"click","click",1912301393),((function (vec__5862,id_sym5859,pnod5860,pnod5860__$1){
return (function (){
...
});})(vec__5862,id_sym5859,pnod5860,pnod5860__$1))
));

enfocus.core.reset_ids.call(null,id_sym5859,pnod5860__$1);

return enfocus.core.remove_node_return_child.call(null,pnod5860__$1);
});

enfocus.core.load_remote_dom.call(null,"/account-details.html","remote/account-details.html","en5845_");
...
return cljs.core.swap_BANG_.call(null,template.app_state,((function (db_id,aname,type_kw,account_cw,vec__5866,id_sym5863,pnod5864,pnod5864__$1){
return (function (e){
return cljs.core.assoc.call(null,e,new cljs.core.Keyword(null,"accounts","accounts",-935308676),cljs.core.map.call(null,((function (db_id,aname,type_kw,account_cw,vec__5866,id_sym5863,pnod5864,pnod5864__$1){
return (function (ee){
...
});})(db_id,aname,type_kw,account_cw,vec__5866,id_sym5863,pnod5864,pnod5864__$1))
...
});})(vec__5866,id_sym5863,pnod5864,pnod5864__$1))
));

enfocus.core.reset_ids.call(null,id_sym5863,pnod5864__$1);

return enfocus.core.remove_node_return_child.call(null,pnod5864__$1);
});

enfocus.core.load_remote_dom.call(null,"/entry-row.html","remote/entry-row.html","en5850_");
...
var vec__5870 = (function (){
return enfocus.core.get_cached_dom.call(null,"remote/entry-row.html");
}).call(null);
var id_sym5867 = cljs.core.nth.call(null,vec__5870,(0),null);
var pnod5868 = cljs.core.nth.call(null,vec__5870,(1),null);
var pnod5868__$1 = enfocus.core.create_hidden_dom.call(null,pnod5868);
enfocus.core.i_at.call(null,id_sym5867,pnod5868__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [".entry-row"], null),enfocus.core.append.call(null,[cljs.core.str(new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(entry))].join('')));

enfocus.core.reset_ids.call(null,id_sym5867,pnod5868__$1);

return enfocus.core.remove_node_return_child.call(null,pnod5868__$1);
});
});
