...
sablono.util.ToString = (function (){var obj110500 = {};
return obj110500;
})();
...
sablono.util.ToURI = (function (){var obj110502 = {};
return obj110502;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__110503){
var xs = cljs.core.seq(arglist__110503);
...
var vec__110505 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__110505,(0),null);
var words = cljs.core.nthnext.call(null,vec__110505,(1));
...
var G__110507 = clojure.set.rename_keys.call(null,m,kmap);
var G__110507__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__110507,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),camel_case_keys):G__110507);
return G__110507__$1;
} else {
return m;
}
});
...
var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__110508_SHARP_){
if(cljs.core.list_QMARK_.call(null,p1__110508_SHARP_)){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__110508_SHARP_], null);
} else {
if(cljs.core.sequential_QMARK_.call(null,p1__110508_SHARP_)){
return p1__110508_SHARP_;
} else {
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__110508_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__110509){
var maps = cljs.core.seq(arglist__110509);
...
var tag_name = cljs.core.nth.call(null,vec__110513,(0),null);
var names = cljs.core.nth.call(null,vec__110513,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__110513,tag_name,names){
return (function (p1__110510_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__110510_SHARP_));
});})(matches,vec__110513,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__110513,tag_name,names){
return (function (p1__110511_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__110511_SHARP_));
});})(matches,vec__110513,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__110514){
var vec__110517 = p__110514;
var tag = cljs.core.nth.call(null,vec__110517,(0),null);
var content = cljs.core.nthnext.call(null,vec__110517,(1));
...
var vec__110518 = sablono.util.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__110518,(0),null);
var id = cljs.core.nth.call(null,vec__110518,(1),null);
var class$ = cljs.core.nth.call(null,vec__110518,(2),null);
