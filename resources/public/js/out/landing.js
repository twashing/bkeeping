...
var map__955199_955200 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__955199_955201__$1 = ((cljs.core.seq_QMARK_.call(null,map__955199_955200))?cljs.core.apply.call(null,cljs.core.hash_map,map__955199_955200):map__955199_955200);
var state_955202 = cljs.core.get.call(null,map__955199_955201__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_955203 = cljs.core.get.call(null,map__955199_955201__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_955204 = cljs.core.get.call(null,map__955199_955201__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_955205 = cljs.core.get.call(null,map__955199_955201__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_955205;

landing.ch_chsk = ch_recv_955204;

landing.chsk_send_BANG_ = send_fn_955203;

landing.chsk_state = state_955202;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__955206){
var map__955207 = p__955206;
var map__955207__$1 = ((cljs.core.seq_QMARK_.call(null,map__955207))?cljs.core.apply.call(null,cljs.core.hash_map,map__955207):map__955207);
var ev_msg = map__955207__$1;
var event = cljs.core.get.call(null,map__955207__$1,new cljs.core.Keyword(null,"event","event",301435442));
return bkeeping.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__955208){
var map__955209 = p__955208;
var map__955209__$1 = ((cljs.core.seq_QMARK_.call(null,map__955209))?cljs.core.apply.call(null,cljs.core.hash_map,map__955209):map__955209);
var ev_msg = map__955209__$1;
var _QMARK_data = cljs.core.get.call(null,map__955209__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__955210){
var map__955211 = p__955210;
var map__955211__$1 = ((cljs.core.seq_QMARK_.call(null,map__955211))?cljs.core.apply.call(null,cljs.core.hash_map,map__955211):map__955211);
var ev_msg = map__955211__$1;
var _QMARK_data = cljs.core.get.call(null,map__955211__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return bkeeping.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__955212){
var map__955214 = p__955212;
var map__955214__$1 = ((cljs.core.seq_QMARK_.call(null,map__955214))?cljs.core.apply.call(null,cljs.core.hash_map,map__955214):map__955214);
var ev_msg = map__955214__$1;
var event = cljs.core.get.call(null,map__955214__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__955214__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__955214__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
