...
var map__21434_21435 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__21434_21436__$1 = ((cljs.core.seq_QMARK_.call(null,map__21434_21435))?cljs.core.apply.call(null,cljs.core.hash_map,map__21434_21435):map__21434_21435);
var state_21437 = cljs.core.get.call(null,map__21434_21436__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_21438 = cljs.core.get.call(null,map__21434_21436__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_21439 = cljs.core.get.call(null,map__21434_21436__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_21440 = cljs.core.get.call(null,map__21434_21436__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_21440;

landing.ch_chsk = ch_recv_21439;

landing.chsk_send_BANG_ = send_fn_21438;

landing.chsk_state = state_21437;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__21441){
...
var ev_msg = map__21442__$1;
var event = cljs.core.get.call(null,map__21442__$1,new cljs.core.Keyword(null,"event","event",301435442));
return util.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__21443){
var map__21444 = p__21443;
var map__21444__$1 = ((cljs.core.seq_QMARK_.call(null,map__21444))?cljs.core.apply.call(null,cljs.core.hash_map,map__21444):map__21444);
var ev_msg = map__21444__$1;
var _QMARK_data = cljs.core.get.call(null,map__21444__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__21445){
var map__21446 = p__21445;
var map__21446__$1 = ((cljs.core.seq_QMARK_.call(null,map__21446))?cljs.core.apply.call(null,cljs.core.hash_map,map__21446):map__21446);
var ev_msg = map__21446__$1;
var _QMARK_data = cljs.core.get.call(null,map__21446__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return util.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__21447){
var map__21449 = p__21447;
var map__21449__$1 = ((cljs.core.seq_QMARK_.call(null,map__21449))?cljs.core.apply.call(null,cljs.core.hash_map,map__21449):map__21449);
var ev_msg = map__21449__$1;
var event = cljs.core.get.call(null,map__21449__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__21449__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__21449__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return util.console_log.call(null,cljs.core.deref.call(null,landing.user_state));
});
