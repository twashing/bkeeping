...
var map__105608_105609 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__105608_105610__$1 = ((cljs.core.seq_QMARK_.call(null,map__105608_105609))?cljs.core.apply.call(null,cljs.core.hash_map,map__105608_105609):map__105608_105609);
var state_105611 = cljs.core.get.call(null,map__105608_105610__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_105612 = cljs.core.get.call(null,map__105608_105610__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_105613 = cljs.core.get.call(null,map__105608_105610__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_105614 = cljs.core.get.call(null,map__105608_105610__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_105614;

landing.ch_chsk = ch_recv_105613;

landing.chsk_send_BANG_ = send_fn_105612;

landing.chsk_state = state_105611;
landing.sendMessage = (function sendMessage(msg){
return landing.chsk_send_BANG_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("t","default","t/default",-1987822452),msg], null));
});
