...
if(typeof landing.t20565 !== 'undefined'){
} else {

/**
* @constructor
*/
landing.t20565 = (function (owner,app,view,meta20566){
this.owner = owner;
this.app = app;
this.view = view;
...
landing.t20565.prototype.om$core$IRender$ = true;

landing.t20565.prototype.om$core$IRender$render$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return document.createElement("div").appendChild(document.createTextNode("fubar"));
});

landing.t20565.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20567){
var self__ = this;
var _20567__$1 = this;
return self__.meta20566;
});

landing.t20565.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20567,meta20566__$1){
var self__ = this;
var _20567__$1 = this;
return (new landing.t20565(self__.owner,self__.app,self__.view,meta20566__$1));
});

landing.t20565.cljs$lang$type = true;

landing.t20565.cljs$lang$ctorStr = "landing/t20565";

landing.t20565.cljs$lang$ctorPrWriter = (function (this__13132__auto__,writer__13133__auto__,opt__13134__auto__){
return cljs.core._write.call(null,writer__13133__auto__,"landing/t20565");
});

landing.__GT_t20565 = (function __GT_t20565(owner__$1,app__$1,view__$2,meta20566){
return (new landing.t20565(owner__$1,app__$1,view__$2,meta20566));
});

}

return (new landing.t20565(owner,app,view__$1,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),32,new cljs.core.Keyword(null,"end-line","end-line",1837326455),84,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),78,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/resources/templ/clojurescript/landing.cljs"], null)));
});
