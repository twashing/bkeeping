...
var map__1272915_1272916 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__1272915_1272917__$1 = ((cljs.core.seq_QMARK_.call(null,map__1272915_1272916))?cljs.core.apply.call(null,cljs.core.hash_map,map__1272915_1272916):map__1272915_1272916);
var state_1272918 = cljs.core.get.call(null,map__1272915_1272917__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_1272919 = cljs.core.get.call(null,map__1272915_1272917__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_1272920 = cljs.core.get.call(null,map__1272915_1272917__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_1272921 = cljs.core.get.call(null,map__1272915_1272917__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_1272921;

landing.ch_chsk = ch_recv_1272920;

landing.chsk_send_BANG_ = send_fn_1272919;

landing.chsk_state = state_1272918;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__1272922){
var map__1272923 = p__1272922;
var map__1272923__$1 = ((cljs.core.seq_QMARK_.call(null,map__1272923))?cljs.core.apply.call(null,cljs.core.hash_map,map__1272923):map__1272923);
var ev_msg = map__1272923__$1;
var event = cljs.core.get.call(null,map__1272923__$1,new cljs.core.Keyword(null,"event","event",301435442));
return bkeeping.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__1272924){
var map__1272925 = p__1272924;
var map__1272925__$1 = ((cljs.core.seq_QMARK_.call(null,map__1272925))?cljs.core.apply.call(null,cljs.core.hash_map,map__1272925):map__1272925);
var ev_msg = map__1272925__$1;
var _QMARK_data = cljs.core.get.call(null,map__1272925__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__1272926){
var map__1272927 = p__1272926;
var map__1272927__$1 = ((cljs.core.seq_QMARK_.call(null,map__1272927))?cljs.core.apply.call(null,cljs.core.hash_map,map__1272927):map__1272927);
var ev_msg = map__1272927__$1;
var _QMARK_data = cljs.core.get.call(null,map__1272927__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return bkeeping.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__1272928){
var map__1272930 = p__1272928;
var map__1272930__$1 = ((cljs.core.seq_QMARK_.call(null,map__1272930))?cljs.core.apply.call(null,cljs.core.hash_map,map__1272930):map__1272930);
var ev_msg = map__1272930__$1;
var event = cljs.core.get.call(null,map__1272930__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__1272930__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__1272930__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
