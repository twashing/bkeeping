...
var map__164217_164218 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__164217_164219__$1 = ((cljs.core.seq_QMARK_.call(null,map__164217_164218))?cljs.core.apply.call(null,cljs.core.hash_map,map__164217_164218):map__164217_164218);
var state_164220 = cljs.core.get.call(null,map__164217_164219__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_164221 = cljs.core.get.call(null,map__164217_164219__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_164222 = cljs.core.get.call(null,map__164217_164219__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_164223 = cljs.core.get.call(null,map__164217_164219__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_164223;

landing.ch_chsk = ch_recv_164222;

landing.chsk_send_BANG_ = send_fn_164221;

landing.chsk_state = state_164220;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__164224){
var map__164225 = p__164224;
var map__164225__$1 = ((cljs.core.seq_QMARK_.call(null,map__164225))?cljs.core.apply.call(null,cljs.core.hash_map,map__164225):map__164225);
var ev_msg = map__164225__$1;
var event = cljs.core.get.call(null,map__164225__$1,new cljs.core.Keyword(null,"event","event",301435442));
return util.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__164226){
var map__164227 = p__164226;
var map__164227__$1 = ((cljs.core.seq_QMARK_.call(null,map__164227))?cljs.core.apply.call(null,cljs.core.hash_map,map__164227):map__164227);
var ev_msg = map__164227__$1;
var _QMARK_data = cljs.core.get.call(null,map__164227__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__164228){
var map__164229 = p__164228;
var map__164229__$1 = ((cljs.core.seq_QMARK_.call(null,map__164229))?cljs.core.apply.call(null,cljs.core.hash_map,map__164229):map__164229);
var ev_msg = map__164229__$1;
var _QMARK_data = cljs.core.get.call(null,map__164229__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return util.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__164230){
var map__164232 = p__164230;
var map__164232__$1 = ((cljs.core.seq_QMARK_.call(null,map__164232))?cljs.core.apply.call(null,cljs.core.hash_map,map__164232):map__164232);
var ev_msg = map__164232__$1;
var event = cljs.core.get.call(null,map__164232__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__164232__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__164232__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return landing.chsk_send_BANG_.call(null,msg_withkey,(5000),(function (cb_reply){
return util.Console_Log.call(null,landing.Str.call(null,"Callback reply: ",cb_reply));
}));
});
