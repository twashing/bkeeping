...
var map__34438_34439 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__34438_34440__$1 = ((cljs.core.seq_QMARK_.call(null,map__34438_34439))?cljs.core.apply.call(null,cljs.core.hash_map,map__34438_34439):map__34438_34439);
var state_34441 = cljs.core.get.call(null,map__34438_34440__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_34442 = cljs.core.get.call(null,map__34438_34440__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_34443 = cljs.core.get.call(null,map__34438_34440__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_34444 = cljs.core.get.call(null,map__34438_34440__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_34444;

landing.ch_chsk = ch_recv_34443;

landing.chsk_send_BANG_ = send_fn_34442;

landing.chsk_state = state_34441;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__34445){
...
var ev_msg = map__34446__$1;
var event = cljs.core.get.call(null,map__34446__$1,new cljs.core.Keyword(null,"event","event",301435442));
return util.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__34447){
var map__34448 = p__34447;
var map__34448__$1 = ((cljs.core.seq_QMARK_.call(null,map__34448))?cljs.core.apply.call(null,cljs.core.hash_map,map__34448):map__34448);
var ev_msg = map__34448__$1;
var _QMARK_data = cljs.core.get.call(null,map__34448__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__34449){
...
var ev_msg = map__34450__$1;
var _QMARK_data = cljs.core.get.call(null,map__34450__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return util.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__34451){
...
var ev_msg = map__34453__$1;
var event = cljs.core.get.call(null,map__34453__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__34453__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__34453__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
...
return landing.chsk_send_BANG_.call(null,msg_withkey,(10000),(function (cb_reply){
