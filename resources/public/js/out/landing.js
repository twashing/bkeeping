...
var map__1020039_1020040 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__1020039_1020041__$1 = ((cljs.core.seq_QMARK_.call(null,map__1020039_1020040))?cljs.core.apply.call(null,cljs.core.hash_map,map__1020039_1020040):map__1020039_1020040);
var state_1020042 = cljs.core.get.call(null,map__1020039_1020041__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_1020043 = cljs.core.get.call(null,map__1020039_1020041__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_1020044 = cljs.core.get.call(null,map__1020039_1020041__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_1020045 = cljs.core.get.call(null,map__1020039_1020041__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_1020045;

landing.ch_chsk = ch_recv_1020044;

landing.chsk_send_BANG_ = send_fn_1020043;

landing.chsk_state = state_1020042;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__1020046){
var map__1020047 = p__1020046;
var map__1020047__$1 = ((cljs.core.seq_QMARK_.call(null,map__1020047))?cljs.core.apply.call(null,cljs.core.hash_map,map__1020047):map__1020047);
var ev_msg = map__1020047__$1;
var event = cljs.core.get.call(null,map__1020047__$1,new cljs.core.Keyword(null,"event","event",301435442));
return bkeeping.console_log.call(null,[cljs.core.str("default event: "),cljs.core.str(event)].join(''));
}));
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__1020048){
var map__1020049 = p__1020048;
var map__1020049__$1 = ((cljs.core.seq_QMARK_.call(null,map__1020049))?cljs.core.apply.call(null,cljs.core.hash_map,map__1020049):map__1020049);
var ev_msg = map__1020049__$1;
var _QMARK_data = cljs.core.get.call(null,map__1020049__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__1020050){
var map__1020051 = p__1020050;
var map__1020051__$1 = ((cljs.core.seq_QMARK_.call(null,map__1020051))?cljs.core.apply.call(null,cljs.core.hash_map,map__1020051):map__1020051);
var ev_msg = map__1020051__$1;
var _QMARK_data = cljs.core.get.call(null,map__1020051__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return bkeeping.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__1020052){
var map__1020054 = p__1020052;
var map__1020054__$1 = ((cljs.core.seq_QMARK_.call(null,map__1020054))?cljs.core.apply.call(null,cljs.core.hash_map,map__1020054):map__1020054);
var ev_msg = map__1020054__$1;
var event = cljs.core.get.call(null,map__1020054__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__1020054__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__1020054__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
