...
var map__27920_27921 = taoensso.sente.make_channel_socket_BANG_.call(null,"/chsk",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"auto","auto",-566279492)], null));
var map__27920_27922__$1 = ((cljs.core.seq_QMARK_.call(null,map__27920_27921))?cljs.core.apply.call(null,cljs.core.hash_map,map__27920_27921):map__27920_27921);
var state_27923 = cljs.core.get.call(null,map__27920_27922__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var send_fn_27924 = cljs.core.get.call(null,map__27920_27922__$1,new cljs.core.Keyword(null,"send-fn","send-fn",351002041));
var ch_recv_27925 = cljs.core.get.call(null,map__27920_27922__$1,new cljs.core.Keyword(null,"ch-recv","ch-recv",-990916861));
var chsk_27926 = cljs.core.get.call(null,map__27920_27922__$1,new cljs.core.Keyword(null,"chsk","chsk",-863703081));
landing.chsk = chsk_27926;

landing.ch_chsk = ch_recv_27925;

landing.chsk_send_BANG_ = send_fn_27924;

landing.chsk_state = state_27923;
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("server","default","server/default",-612784709),(function (p__27927){
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","state","chsk/state",-1991397620),(function (p__27929){
var map__27930 = p__27929;
var map__27930__$1 = ((cljs.core.seq_QMARK_.call(null,map__27930))?cljs.core.apply.call(null,cljs.core.hash_map,map__27930):map__27930);
var ev_msg = map__27930__$1;
var _QMARK_data = cljs.core.get.call(null,map__27930__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
...
cljs.core._add_method.call(null,landing.event_msg_handler,new cljs.core.Keyword("chsk","recv","chsk/recv",561097091),(function (p__27931){
...
var ev_msg = map__27932__$1;
var _QMARK_data = cljs.core.get.call(null,map__27932__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
return util.console_log.call(null,[cljs.core.str("Push event from server: "),cljs.core.str(_QMARK_data)].join(''));
}));
landing.event_msg_handler_STAR_ = (function event_msg_handler_STAR_(p__27933){
var map__27935 = p__27933;
var map__27935__$1 = ((cljs.core.seq_QMARK_.call(null,map__27935))?cljs.core.apply.call(null,cljs.core.hash_map,map__27935):map__27935);
var ev_msg = map__27935__$1;
var event = cljs.core.get.call(null,map__27935__$1,new cljs.core.Keyword(null,"event","event",301435442));
var _QMARK_data = cljs.core.get.call(null,map__27935__$1,new cljs.core.Keyword(null,"?data","?data",-9471433));
var id = cljs.core.get.call(null,map__27935__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
