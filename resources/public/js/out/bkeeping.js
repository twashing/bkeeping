...
bkeeping.simpleXhrSentinel = (function simpleXhrSentinel(xhr){return (function (){if(cljs.core._EQ_.call(null,(4),xhr.readyState))
{if(cljs.core._EQ_.call(null,(200),xhr.status))
{return bkeeping.console_log.call(null,("XMLHttpRequest SUCCESS: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(xhr.status)));
} else
{return bkeeping.console_log.call(null,("XMLHttpRequest ERROR: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(xhr.status)));
}
} else
{return null;
}
...
bkeeping.verifyAssertion_XMLHttpRequest = (function verifyAssertion_XMLHttpRequest(assertion){bkeeping.console_log.call(null,("verifyAssertion CALLED / assertion: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(assertion)));
var xml_http_request = (function (){return (new XMLHttpRequest());
});var xhr = xml_http_request.call(null);var param = ("assertion="+cljs.core.str.cljs$core$IFn$_invoke$arity$1(assertion));xhr.open("POST","/verify-assertion",true);
xhr.setRequestHeader("Content-type".call(null,"application/x-www-form-urlencoded"));
xhr.setRequestHeader("Content-length".call(null,param.length()));
xhr.setRequestHeader("Connection".call(null,"close"));
xhr.send(param);
return xhr.onreadystatechange = bkeeping.simpleXhrSentinel.call(null,xhr);
});
...
return bkeeping.edn_xhr.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"method","method",55703592),new cljs.core.Keyword(null,"post","post",269697687),new cljs.core.Keyword(null,"url","url",276297046),"/verify-assertion",new cljs.core.Keyword(null,"data","data",-232669377),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"assertion","assertion",-1645134882),assertion], null),new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971),(function (res){return bkeeping.console_log.call(null,("server response:"+cljs.core.str.cljs$core$IFn$_invoke$arity$1(res)));
})], null));
});
