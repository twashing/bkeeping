...
bkeeping.transitionAccounts = (function transitionAccounts(){
var as = goog.dom.getElement("accounts");
return as.selected = ((1) + as.selected);
});
bkeeping.transitionEntries = (function transitionEntries(){
var es = goog.dom.getElement("entries");
return es.selected = ((1) + es.selected);
});
...
bkeeping.edn_xhr = (function edn_xhr(p__14068){
var map__14070 = p__14068;
var map__14070__$1 = ((cljs.core.seq_QMARK_.call(null,map__14070))?cljs.core.apply.call(null,cljs.core.hash_map,map__14070):map__14070);
var on_complete = cljs.core.get.call(null,map__14070__$1,new cljs.core.Keyword(null,"on-complete","on-complete",-1531183971));
var data = cljs.core.get.call(null,map__14070__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var url = cljs.core.get.call(null,map__14070__$1,new cljs.core.Keyword(null,"url","url",276297046));
var method = cljs.core.get.call(null,map__14070__$1,new cljs.core.Keyword(null,"method","method",55703592));
var xhr = (new goog.net.XhrIo());
goog.events.listen(xhr,goog.net.EventType.COMPLETE,((function (xhr,map__14070,map__14070__$1,on_complete,data,url,method){
return (function (e){
return on_complete.call(null,cljs.reader.read_string.call(null,xhr.getResponseText()));
});})(xhr,map__14070,map__14070__$1,on_complete,data,url,method))
);
...
bkeeping.onClickHandler = (function onClickHandler(){
...
bkeeping.start = (function start(){
var signinLink = goog.dom.getElement("signin");
return signinLink.onclick = bkeeping.onClickHandler;
});
