...
taoensso.sente.interfaces.IPacker = (function (){var obj27415 = {};
return obj27415;
})();
...
return G__27417.taoensso$sente$interfaces$IPacker$;
}
})())){
return true;
} else {
if((!G__27417.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__27417);
} else {
return false;
}
}
