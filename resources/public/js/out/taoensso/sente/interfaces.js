...
taoensso.sente.interfaces.IPacker = (function (){var obj137719 = {};
return obj137719;
})();
...
return G__137721.taoensso$sente$interfaces$IPacker$;
}
})())){
return true;
} else {
if((!G__137721.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,taoensso.sente.interfaces.IPacker,G__137721);
} else {
return false;
}
}
