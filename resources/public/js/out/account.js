...
account.handle_name_change = (function handle_name_change(e,owner,p__131752){
var map__131754 = p__131752;
var map__131754__$1 = ((cljs.core.seq_QMARK_.call(null,map__131754))?cljs.core.apply.call(null,cljs.core.hash_map,map__131754):map__131754);
var name = cljs.core.get.call(null,map__131754__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t131761 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t131761 = (function (owner,account,account_view,meta131762){
this.owner = owner;
this.account = account;
this.account_view = account_view;
this.meta131762 = meta131762;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t131761.prototype.om$core$IRenderState$ = true;

account.t131761.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return (function (p1__131755_SHARP_){
return account.handle_name_change.call(null,p1__131755_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return (function (p1__131756_SHARP_,p2__131757_SHARP_){
return account.handle_type_change.call(null,p1__131756_SHARP_,self__.owner,p2__131757_SHARP_);
});})(this$__$1))
...
account.t131761.prototype.om$core$IInitState$ = true;

account.t131761.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t131761.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_131763){
var self__ = this;
var _131763__$1 = this;
return self__.meta131762;
});

account.t131761.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_131763,meta131762__$1){
var self__ = this;
var _131763__$1 = this;
return (new account.t131761(self__.owner,self__.account,self__.account_view,meta131762__$1));
});

account.t131761.cljs$lang$type = true;

account.t131761.cljs$lang$ctorStr = "account/t131761";

account.t131761.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t131761");
});

account.__GT_t131761 = (function __GT_t131761(owner__$1,account__$2,account_view__$1,meta131762){
return (new account.t131761(owner__$1,account__$2,account_view__$1,meta131762));
});

}

return (new account.t131761(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t131773 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t131773 = (function (owner,state,accounts_view,meta131774){
this.owner = owner;
this.state = state;
this.accounts_view = accounts_view;
this.meta131774 = meta131774;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t131773.prototype.om$core$IRender$ = true;

account.t131773.prototype.om$core$IRender$render$arity$1 = (function (this__21314__auto__){
var self__ = this;
...
return (function iter__131778(s__131779){
return (new cljs.core.LazySeq(null,((function (this__21314__auto____$1){
return (function (){
var s__131779__$1 = s__131779;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__131779__$1);
if(temp__4126__auto__){
var s__131779__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__131779__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__131779__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__131781 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__131780 = (0);
while(true){
if((i__131780 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__131780);
cljs.core.chunk_append.call(null,b__131781,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__131780,ech,c__4376__auto__,size__4377__auto__,b__131781,s__131779__$2,temp__4126__auto__,this__21314__auto____$1){
return (function (e){
...
});})(i__131780,ech,c__4376__auto__,size__4377__auto__,b__131781,s__131779__$2,temp__4126__auto__,this__21314__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__131781),iter__131778.call(null,cljs.core.chunk_rest.call(null,s__131779__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__131781),null);
}
} else {
var ech = cljs.core.first.call(null,s__131779__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__131779__$2,temp__4126__auto__,this__21314__auto____$1){
return (function (e){
util.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__131779__$2,temp__4126__auto__,this__21314__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__131778.call(null,cljs.core.rest.call(null,s__131779__$2)));
}
} else {
return null;
}
...
account.t131773.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_131775){
var self__ = this;
var _131775__$1 = this;
return self__.meta131774;
});

account.t131773.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_131775,meta131774__$1){
var self__ = this;
var _131775__$1 = this;
return (new account.t131773(self__.owner,self__.state,self__.accounts_view,meta131774__$1));
});

account.t131773.cljs$lang$type = true;

account.t131773.cljs$lang$ctorStr = "account/t131773";

account.t131773.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t131773");
});

account.__GT_t131773 = (function __GT_t131773(owner__$1,state__$1,accounts_view__$1,meta131774){
return (new account.t131773(owner__$1,state__$1,accounts_view__$1,meta131774));
});

}

return (new account.t131773(owner,state,accounts_view,null));
});
