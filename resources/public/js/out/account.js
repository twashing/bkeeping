...
account.handle_name_change = (function handle_name_change(e,owner,p__157704){
var map__157706 = p__157704;
var map__157706__$1 = ((cljs.core.seq_QMARK_.call(null,map__157706))?cljs.core.apply.call(null,cljs.core.hash_map,map__157706):map__157706);
var name = cljs.core.get.call(null,map__157706__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t157713 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t157713 = (function (owner,account,account_view,meta157714){
this.owner = owner;
this.account = account;
this.account_view = account_view;
this.meta157714 = meta157714;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t157713.prototype.om$core$IRenderState$ = true;

account.t157713.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return (function (p1__157707_SHARP_){
return account.handle_name_change.call(null,p1__157707_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return (function (p1__157708_SHARP_,p2__157709_SHARP_){
return account.handle_type_change.call(null,p1__157708_SHARP_,self__.owner,p2__157709_SHARP_);
});})(this$__$1))
...
account.t157713.prototype.om$core$IInitState$ = true;

account.t157713.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t157713.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_157715){
var self__ = this;
var _157715__$1 = this;
return self__.meta157714;
});

account.t157713.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_157715,meta157714__$1){
var self__ = this;
var _157715__$1 = this;
return (new account.t157713(self__.owner,self__.account,self__.account_view,meta157714__$1));
});

account.t157713.cljs$lang$type = true;

account.t157713.cljs$lang$ctorStr = "account/t157713";

account.t157713.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t157713");
});

account.__GT_t157713 = (function __GT_t157713(owner__$1,account__$2,account_view__$1,meta157714){
return (new account.t157713(owner__$1,account__$2,account_view__$1,meta157714));
});

}

return (new account.t157713(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t157725 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t157725 = (function (owner,state,accounts_view,meta157726){
this.owner = owner;
this.state = state;
this.accounts_view = accounts_view;
this.meta157726 = meta157726;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t157725.prototype.om$core$IRender$ = true;

account.t157725.prototype.om$core$IRender$render$arity$1 = (function (this__21314__auto__){
var self__ = this;
...
return (function iter__157730(s__157731){
return (new cljs.core.LazySeq(null,((function (this__21314__auto____$1){
return (function (){
var s__157731__$1 = s__157731;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__157731__$1);
if(temp__4126__auto__){
var s__157731__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__157731__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__157731__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__157733 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__157732 = (0);
while(true){
if((i__157732 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__157732);
cljs.core.chunk_append.call(null,b__157733,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__157732,ech,c__4376__auto__,size__4377__auto__,b__157733,s__157731__$2,temp__4126__auto__,this__21314__auto____$1){
return (function (e){
...
});})(i__157732,ech,c__4376__auto__,size__4377__auto__,b__157733,s__157731__$2,temp__4126__auto__,this__21314__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__157733),iter__157730.call(null,cljs.core.chunk_rest.call(null,s__157731__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__157733),null);
}
} else {
var ech = cljs.core.first.call(null,s__157731__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__157731__$2,temp__4126__auto__,this__21314__auto____$1){
return (function (e){
util.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__157731__$2,temp__4126__auto__,this__21314__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__157730.call(null,cljs.core.rest.call(null,s__157731__$2)));
}
} else {
return null;
}
...
account.t157725.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_157727){
var self__ = this;
var _157727__$1 = this;
return self__.meta157726;
});

account.t157725.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_157727,meta157726__$1){
var self__ = this;
var _157727__$1 = this;
return (new account.t157725(self__.owner,self__.state,self__.accounts_view,meta157726__$1));
});

account.t157725.cljs$lang$type = true;

account.t157725.cljs$lang$ctorStr = "account/t157725";

account.t157725.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t157725");
});

account.__GT_t157725 = (function __GT_t157725(owner__$1,state__$1,accounts_view__$1,meta157726){
return (new account.t157725(owner__$1,state__$1,accounts_view__$1,meta157726));
});

}

return (new account.t157725(owner,state,accounts_view,null));
});
