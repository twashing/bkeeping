...
account.handle_name_change = (function handle_name_change(e,owner,p__9124){
...
var name = cljs.core.get.call(null,map__9126__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t9133 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t9133 = (function (owner,account,account_view,meta9134){
this.owner = owner;
...
account.t9133.prototype.om$core$IRenderState$ = true;

account.t9133.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return account.handle_name_change.call(null,p1__9127_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return (function (p1__9128_SHARP_,p2__9129_SHARP_){
return account.handle_type_change.call(null,p1__9128_SHARP_,self__.owner,p2__9129_SHARP_);
});})(this$__$1))
...
account.t9133.prototype.om$core$IInitState$ = true;

account.t9133.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t9133.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9135){
var self__ = this;
var _9135__$1 = this;
return self__.meta9134;
});

account.t9133.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9135,meta9134__$1){
var self__ = this;
var _9135__$1 = this;
return (new account.t9133(self__.owner,self__.account,self__.account_view,meta9134__$1));
});

account.t9133.cljs$lang$type = true;

account.t9133.cljs$lang$ctorStr = "account/t9133";

account.t9133.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t9133");
});

account.__GT_t9133 = (function __GT_t9133(owner__$1,account__$2,account_view__$1,meta9134){
return (new account.t9133(owner__$1,account__$2,account_view__$1,meta9134));
});

}

return (new account.t9133(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t9145 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t9145 = (function (owner,state,accounts_view,meta9146){
this.owner = owner;
this.state = state;
...
account.t9145.prototype.om$core$IRender$ = true;

account.t9145.prototype.om$core$IRender$render$arity$1 = (function (this__8593__auto__){
var self__ = this;
...
return (function iter__9150(s__9151){
return (new cljs.core.LazySeq(null,((function (this__8593__auto____$1){
return (function (){
var s__9151__$1 = s__9151;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__9151__$1);
if(temp__4126__auto__){
var s__9151__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__9151__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__9151__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__9153 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__9152 = (0);
while(true){
if((i__9152 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__9152);
cljs.core.chunk_append.call(null,b__9153,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__9152,ech,c__4376__auto__,size__4377__auto__,b__9153,s__9151__$2,temp__4126__auto__,this__8593__auto____$1){
return (function (e){
...
});})(i__9152,ech,c__4376__auto__,size__4377__auto__,b__9153,s__9151__$2,temp__4126__auto__,this__8593__auto____$1))
...
var ech = cljs.core.first.call(null,s__9151__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__9151__$2,temp__4126__auto__,this__8593__auto____$1){
return (function (e){
bkeeping.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__9151__$2,temp__4126__auto__,this__8593__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__9150.call(null,cljs.core.rest.call(null,s__9151__$2)));
}
} else {
return null;
}
...
account.t9145.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_9147){
var self__ = this;
var _9147__$1 = this;
return self__.meta9146;
});

account.t9145.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_9147,meta9146__$1){
var self__ = this;
var _9147__$1 = this;
return (new account.t9145(self__.owner,self__.state,self__.accounts_view,meta9146__$1));
});

account.t9145.cljs$lang$type = true;

account.t9145.cljs$lang$ctorStr = "account/t9145";

account.t9145.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t9145");
});

account.__GT_t9145 = (function __GT_t9145(owner__$1,state__$1,accounts_view__$1,meta9146){
return (new account.t9145(owner__$1,state__$1,accounts_view__$1,meta9146));
});

}

return (new account.t9145(owner,state,accounts_view,null));
});
