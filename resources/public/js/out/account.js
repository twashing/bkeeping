...
account.handle_name_change = (function handle_name_change(e,owner,p__13235){
var map__13237 = p__13235;
...
var name = cljs.core.get.call(null,map__13237__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t13244 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t13244 = (function (owner,account,account_view,meta13245){
this.owner = owner;
...
account.t13244.prototype.om$core$IRenderState$ = true;

account.t13244.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return account.handle_name_change.call(null,p1__13238_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return account.handle_type_change.call(null,p1__13239_SHARP_,self__.owner,p2__13240_SHARP_);
});})(this$__$1))
...
account.t13244.prototype.om$core$IInitState$ = true;

account.t13244.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t13244.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13246){
var self__ = this;
var _13246__$1 = this;
return self__.meta13245;
});

account.t13244.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13246,meta13245__$1){
var self__ = this;
var _13246__$1 = this;
return (new account.t13244(self__.owner,self__.account,self__.account_view,meta13245__$1));
});

account.t13244.cljs$lang$type = true;

account.t13244.cljs$lang$ctorStr = "account/t13244";

account.t13244.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t13244");
});

account.__GT_t13244 = (function __GT_t13244(owner__$1,account__$2,account_view__$1,meta13245){
return (new account.t13244(owner__$1,account__$2,account_view__$1,meta13245));
});

}

return (new account.t13244(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t13256 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t13256 = (function (owner,state,accounts_view,meta13257){
this.owner = owner;
this.state = state;
...
account.t13256.prototype.om$core$IRender$ = true;

account.t13256.prototype.om$core$IRender$render$arity$1 = (function (this__8580__auto__){
var self__ = this;
...
return (function iter__13261(s__13262){
return (new cljs.core.LazySeq(null,((function (this__8580__auto____$1){
return (function (){
var s__13262__$1 = s__13262;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__13262__$1);
if(temp__4126__auto__){
var s__13262__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__13262__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__13262__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__13264 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__13263 = (0);
while(true){
if((i__13263 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__13263);
cljs.core.chunk_append.call(null,b__13264,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__13263,ech,c__4376__auto__,size__4377__auto__,b__13264,s__13262__$2,temp__4126__auto__,this__8580__auto____$1){
return (function (e){
...
});})(i__13263,ech,c__4376__auto__,size__4377__auto__,b__13264,s__13262__$2,temp__4126__auto__,this__8580__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13264),iter__13261.call(null,cljs.core.chunk_rest.call(null,s__13262__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13264),null);
}
} else {
var ech = cljs.core.first.call(null,s__13262__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__13262__$2,temp__4126__auto__,this__8580__auto____$1){
return (function (e){
bkeeping.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__13262__$2,temp__4126__auto__,this__8580__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__13261.call(null,cljs.core.rest.call(null,s__13262__$2)));
}
} else {
return null;
}
...
account.t13256.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13258){
var self__ = this;
var _13258__$1 = this;
return self__.meta13257;
});

account.t13256.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13258,meta13257__$1){
var self__ = this;
var _13258__$1 = this;
return (new account.t13256(self__.owner,self__.state,self__.accounts_view,meta13257__$1));
});

account.t13256.cljs$lang$type = true;

account.t13256.cljs$lang$ctorStr = "account/t13256";

account.t13256.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t13256");
});

account.__GT_t13256 = (function __GT_t13256(owner__$1,state__$1,accounts_view__$1,meta13257){
return (new account.t13256(owner__$1,state__$1,accounts_view__$1,meta13257));
});

}

return (new account.t13256(owner,state,accounts_view,null));
});
