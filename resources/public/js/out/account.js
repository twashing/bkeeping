...
account.handle_name_change = (function handle_name_change(e,owner,p__27936){
...
var name = cljs.core.get.call(null,map__27938__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t27945 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t27945 = (function (owner,account,account_view,meta27946){
this.owner = owner;
...
account.t27945.prototype.om$core$IRenderState$ = true;

account.t27945.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return account.handle_name_change.call(null,p1__27939_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return account.handle_type_change.call(null,p1__27940_SHARP_,self__.owner,p2__27941_SHARP_);
});})(this$__$1))
...
account.t27945.prototype.om$core$IInitState$ = true;

account.t27945.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t27945.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27947){
var self__ = this;
var _27947__$1 = this;
return self__.meta27946;
});

account.t27945.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27947,meta27946__$1){
var self__ = this;
var _27947__$1 = this;
return (new account.t27945(self__.owner,self__.account,self__.account_view,meta27946__$1));
});

account.t27945.cljs$lang$type = true;

account.t27945.cljs$lang$ctorStr = "account/t27945";

account.t27945.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t27945");
});

account.__GT_t27945 = (function __GT_t27945(owner__$1,account__$2,account_view__$1,meta27946){
return (new account.t27945(owner__$1,account__$2,account_view__$1,meta27946));
});

}

return (new account.t27945(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t27957 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t27957 = (function (owner,state,accounts_view,meta27958){
this.owner = owner;
this.state = state;
...
account.t27957.prototype.om$core$IRender$ = true;

account.t27957.prototype.om$core$IRender$render$arity$1 = (function (this__21321__auto__){
var self__ = this;
var this__21321__auto____$1 = this;
return React.DOM.div({"id": "accounts-pane", "slideFromRight": true},cljs.core.into_array.call(null,(function (){var iter__4378__auto__ = ((function (this__21321__auto____$1){
return (function iter__27962(s__27963){
return (new cljs.core.LazySeq(null,((function (this__21321__auto____$1){
return (function (){
var s__27963__$1 = s__27963;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__27963__$1);
if(temp__4126__auto__){
var s__27963__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__27963__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__27963__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__27965 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__27964 = (0);
while(true){
if((i__27964 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__27964);
cljs.core.chunk_append.call(null,b__27965,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__27964,ech,c__4376__auto__,size__4377__auto__,b__27965,s__27963__$2,temp__4126__auto__,this__21321__auto____$1){
return (function (e){
...
});})(i__27964,ech,c__4376__auto__,size__4377__auto__,b__27965,s__27963__$2,temp__4126__auto__,this__21321__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27965),iter__27962.call(null,cljs.core.chunk_rest.call(null,s__27963__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__27965),null);
}
} else {
var ech = cljs.core.first.call(null,s__27963__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__27963__$2,temp__4126__auto__,this__21321__auto____$1){
return (function (e){
util.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__27963__$2,temp__4126__auto__,this__21321__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__27962.call(null,cljs.core.rest.call(null,s__27963__$2)));
}
} else {
return null;
}
...
account.t27957.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27959){
var self__ = this;
var _27959__$1 = this;
return self__.meta27958;
});

account.t27957.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27959,meta27958__$1){
var self__ = this;
var _27959__$1 = this;
return (new account.t27957(self__.owner,self__.state,self__.accounts_view,meta27958__$1));
});

account.t27957.cljs$lang$type = true;

account.t27957.cljs$lang$ctorStr = "account/t27957";

account.t27957.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t27957");
});

account.__GT_t27957 = (function __GT_t27957(owner__$1,state__$1,accounts_view__$1,meta27958){
return (new account.t27957(owner__$1,state__$1,accounts_view__$1,meta27958));
});

}

return (new account.t27957(owner,state,accounts_view,null));
});
