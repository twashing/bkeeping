...
account.handle_name_change = (function handle_name_change(e,owner,p__955215){
var map__955217 = p__955215;
var map__955217__$1 = ((cljs.core.seq_QMARK_.call(null,map__955217))?cljs.core.apply.call(null,cljs.core.hash_map,map__955217):map__955217);
var name = cljs.core.get.call(null,map__955217__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t955224 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t955224 = (function (owner,account,account_view,meta955225){
this.owner = owner;
this.account = account;
this.account_view = account_view;
this.meta955225 = meta955225;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t955224.prototype.om$core$IRenderState$ = true;

account.t955224.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return (function (p1__955218_SHARP_){
return account.handle_name_change.call(null,p1__955218_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return (function (p1__955219_SHARP_,p2__955220_SHARP_){
return account.handle_type_change.call(null,p1__955219_SHARP_,self__.owner,p2__955220_SHARP_);
});})(this$__$1))
...
account.t955224.prototype.om$core$IInitState$ = true;

account.t955224.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t955224.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_955226){
var self__ = this;
var _955226__$1 = this;
return self__.meta955225;
});

account.t955224.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_955226,meta955225__$1){
var self__ = this;
var _955226__$1 = this;
return (new account.t955224(self__.owner,self__.account,self__.account_view,meta955225__$1));
});

account.t955224.cljs$lang$type = true;

account.t955224.cljs$lang$ctorStr = "account/t955224";

account.t955224.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t955224");
});

account.__GT_t955224 = (function __GT_t955224(owner__$1,account__$2,account_view__$1,meta955225){
return (new account.t955224(owner__$1,account__$2,account_view__$1,meta955225));
});

}

return (new account.t955224(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t955236 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t955236 = (function (owner,state,accounts_view,meta955237){
this.owner = owner;
this.state = state;
this.accounts_view = accounts_view;
this.meta955237 = meta955237;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
account.t955236.prototype.om$core$IRender$ = true;

account.t955236.prototype.om$core$IRender$render$arity$1 = (function (this__9858__auto__){
var self__ = this;
...
return (function iter__955241(s__955242){
return (new cljs.core.LazySeq(null,((function (this__9858__auto____$1){
return (function (){
var s__955242__$1 = s__955242;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__955242__$1);
if(temp__4126__auto__){
var s__955242__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__955242__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__955242__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__955244 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__955243 = (0);
while(true){
if((i__955243 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__955243);
cljs.core.chunk_append.call(null,b__955244,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__955243,ech,c__4376__auto__,size__4377__auto__,b__955244,s__955242__$2,temp__4126__auto__,this__9858__auto____$1){
return (function (e){
...
});})(i__955243,ech,c__4376__auto__,size__4377__auto__,b__955244,s__955242__$2,temp__4126__auto__,this__9858__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__955244),iter__955241.call(null,cljs.core.chunk_rest.call(null,s__955242__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__955244),null);
}
} else {
var ech = cljs.core.first.call(null,s__955242__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__955242__$2,temp__4126__auto__,this__9858__auto____$1){
return (function (e){
bkeeping.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__955242__$2,temp__4126__auto__,this__9858__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__955241.call(null,cljs.core.rest.call(null,s__955242__$2)));
}
} else {
return null;
}
...
account.t955236.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_955238){
var self__ = this;
var _955238__$1 = this;
return self__.meta955237;
});

account.t955236.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_955238,meta955237__$1){
var self__ = this;
var _955238__$1 = this;
return (new account.t955236(self__.owner,self__.state,self__.accounts_view,meta955237__$1));
});

account.t955236.cljs$lang$type = true;

account.t955236.cljs$lang$ctorStr = "account/t955236";

account.t955236.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t955236");
});

account.__GT_t955236 = (function __GT_t955236(owner__$1,state__$1,accounts_view__$1,meta955237){
return (new account.t955236(owner__$1,state__$1,accounts_view__$1,meta955237));
});

}

return (new account.t955236(owner,state,accounts_view,null));
});
