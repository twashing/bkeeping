...
account.handle_name_change = (function handle_name_change(e,owner,p__21448){
var map__21450 = p__21448;
var map__21450__$1 = ((cljs.core.seq_QMARK_.call(null,map__21450))?cljs.core.apply.call(null,cljs.core.hash_map,map__21450):map__21450);
var name = cljs.core.get.call(null,map__21450__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
if(typeof account.t21457 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t21457 = (function (owner,account,account_view,meta21458){
this.owner = owner;
...
account.t21457.prototype.om$core$IRenderState$ = true;

account.t21457.prototype.om$core$IRenderState$render_state$arity$2 = (function (this$,state){
var self__ = this;
var this$__$1 = this;
...
return account.handle_name_change.call(null,p1__21451_SHARP_,self__.owner,self__.account);
});})(this$__$1))
...
return account.handle_type_change.call(null,p1__21452_SHARP_,self__.owner,p2__21453_SHARP_);
});})(this$__$1))
...
account.t21457.prototype.om$core$IInitState$ = true;

account.t21457.prototype.om$core$IInitState$init_state$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
account.t21457.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21459){
var self__ = this;
var _21459__$1 = this;
return self__.meta21458;
});

account.t21457.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21459,meta21458__$1){
var self__ = this;
var _21459__$1 = this;
return (new account.t21457(self__.owner,self__.account,self__.account_view,meta21458__$1));
});

account.t21457.cljs$lang$type = true;

account.t21457.cljs$lang$ctorStr = "account/t21457";

account.t21457.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t21457");
});

account.__GT_t21457 = (function __GT_t21457(owner__$1,account__$2,account_view__$1,meta21458){
return (new account.t21457(owner__$1,account__$2,account_view__$1,meta21458));
});

}

return (new account.t21457(owner,account__$1,account_view,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"end-column","end-column",1425389514),23,new cljs.core.Keyword(null,"end-line","end-line",1837326455),87,new cljs.core.Keyword(null,"column","column",2078222095),3,new cljs.core.Keyword(null,"line","line",212345235),38,new cljs.core.Keyword(null,"file","file",-1269645878),"/home/twashing/Projects/bkeeping/src/cljs/account.cljs"], null)));
});
account.accounts_view = (function accounts_view(state,owner){
if(typeof account.t21469 !== 'undefined'){
} else {

/**
* @constructor
*/
account.t21469 = (function (owner,state,accounts_view,meta21470){
this.owner = owner;
this.state = state;
...
account.t21469.prototype.om$core$IRender$ = true;

account.t21469.prototype.om$core$IRender$render$arity$1 = (function (this__21324__auto__){
var self__ = this;
...
return (function iter__21474(s__21475){
return (new cljs.core.LazySeq(null,((function (this__21324__auto____$1){
return (function (){
var s__21475__$1 = s__21475;
while(true){
var temp__4126__auto__ = cljs.core.seq.call(null,s__21475__$1);
if(temp__4126__auto__){
var s__21475__$2 = temp__4126__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__21475__$2)){
var c__4376__auto__ = cljs.core.chunk_first.call(null,s__21475__$2);
var size__4377__auto__ = cljs.core.count.call(null,c__4376__auto__);
var b__21477 = cljs.core.chunk_buffer.call(null,size__4377__auto__);
if((function (){var i__21476 = (0);
while(true){
if((i__21476 < size__4377__auto__)){
var ech = cljs.core._nth.call(null,c__4376__auto__,i__21476);
cljs.core.chunk_append.call(null,b__21477,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (i__21476,ech,c__4376__auto__,size__4377__auto__,b__21477,s__21475__$2,temp__4126__auto__,this__21324__auto____$1){
return (function (e){
...
});})(i__21476,ech,c__4376__auto__,size__4377__auto__,b__21477,s__21475__$2,temp__4126__auto__,this__21324__auto____$1))
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21477),iter__21474.call(null,cljs.core.chunk_rest.call(null,s__21475__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__21477),null);
}
} else {
var ech = cljs.core.first.call(null,s__21475__$2);
return cljs.core.cons.call(null,React.DOM.div({"className": "delete-account-row", "horizontal": true, "layout": true},React.DOM.div({"className": "delete-account-button"}),React.DOM.div({"className": "account-row", "flex": true, "onClick": ((function (ech,s__21475__$2,temp__4126__auto__,this__21324__auto____$1){
return (function (e){
util.transitionAccountsForward.call(null);

return om.core.root.call(null,account.account_view,ech,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"target","target",253001721),document.getElementById("account-section")], null));
});})(ech,s__21475__$2,temp__4126__auto__,this__21324__auto____$1))
},sablono.interpreter.interpret.call(null,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(ech)))),iter__21474.call(null,cljs.core.rest.call(null,s__21475__$2)));
}
} else {
return null;
}
...
account.t21469.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_21471){
var self__ = this;
var _21471__$1 = this;
return self__.meta21470;
});

account.t21469.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_21471,meta21470__$1){
var self__ = this;
var _21471__$1 = this;
return (new account.t21469(self__.owner,self__.state,self__.accounts_view,meta21470__$1));
});

account.t21469.cljs$lang$type = true;

account.t21469.cljs$lang$ctorStr = "account/t21469";

account.t21469.cljs$lang$ctorPrWriter = (function (this__4209__auto__,writer__4210__auto__,opt__4211__auto__){
return cljs.core._write.call(null,writer__4210__auto__,"account/t21469");
});

account.__GT_t21469 = (function __GT_t21469(owner__$1,state__$1,accounts_view__$1,meta21470){
return (new account.t21469(owner__$1,state__$1,accounts_view__$1,meta21470));
});

}

return (new account.t21469(owner,state,accounts_view,null));
});
